 ...
 */
#ifdef FAST_CHUNK_NOSSSE3
void ZLIB_INTERNAL inflate_fast_chunk_nossse3(strm, start)
#else   
...
#ifdef FAST_CHUNK_NOSSSE3
int ZEXPORT inflate_nossse3(strm, flush)
#else
    ...
    for (;;)
        ...
        case LEN:
            if (have >= INFLATE_FAST_MIN_INPUT &&
                ...
                RESTORE();
#ifdef FAST_CHUNK_NOSSSE3
                inflate_fast_chunk_nossse3(strm, out);
#else                
