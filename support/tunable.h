...
# endif
	...
	P4TUNE_SYS_MEMORY_MI_DECOMMIT_DELAY,	// see mihandler.cc
	...
	P4TUNE_SYS_MEMORY_MI_ALLOWDECOMMIT,	// see mihandler.cc // moved up?
	P4TUNE_SYS_MEMORY_MI_SEGMENTDECOMMITDELAY, // see mihandler.cc
	P4TUNE_SYS_MEMORY_MI_DECOMMITEXTENDDELAY, // see mihandler.cc
