...
P4Tunable::tunable P4Tunable::list[] = {
	...
	{ "proxy.clearcachethresh",	0,	0,	0,	RBIG,	1,	1,	0,	1,	&MsgConfig::ProxyClearcachethresh,	0,	CONFIG_APPLY_PROXY,	CONFIG_RESTART_NO_RESTART,	CONFIG_SUPPORT_DOC,	CONFIG_CAT_MISC },
