...
P4Tunable::tunable P4Tunable::list[] = {
	...
	{ "dm.batch.net",		0,	R1K,	1,	RBIG,	1,	R1K, 0 },
	...
	{ "dm.integ.streamspec",	0,	1,	0,	2,	1,	1,   0 },
	...
	{ "dm.repo.unpack",	0,	1,	0,	2,	1,	1, 0 },
	{ "dm.resolve.attrib",	0,	1,	0,	1,	1,	1, 0 },
	{ "dm.resolve.ignoredeleted",	0,	0,	0,	1,	1,	1, 0 },
	...
	{ "dm.stream.parentview",	0,	0,	0,	2,	1,	1,   0 },
	...
	{ "lbr.storage.skipkeyed",0,	2,	0,	BBIG,	1,	1, 0 },
	{ "lbr.rcs.locking",	0,	0,	0,	1,	1,	1, 0 },
	...
	{ "rpl.track.behind",	0,	0,	0,	2,	1,	1, 0 },
	{ "rpl.track.behind.interval",	0,	R10K,	0,	RBIG,	1,	R1K, 0 },
	{ "rpl.verify.cache",	0,	0,	0,	1,	1,	1, 0 },
	{ "rpl.verify.shared",	0,	1,	0,	1,	1,	1, 0 },
	{ "rpl.pull.archivedepots",0,	0,	0,	1,	1,	1, 0 },
	...
	{ "server.extensions.allow.admin", 0,	1,	0,	1,	1,	1, 0 },
	{ "server.extensions.allow.unsigned", 0,	0,	0,	1,	1,	1, 0 },
	...
	{ "ssl.client.tls.version.min",	0,	12,	10,	13,	1,	1, 0 },
	{ "ssl.client.tls.version.max",	0,	13,	10,	13,	1,	1, 0 },
