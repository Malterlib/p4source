...
ErrorId MsgServer::UseCopy             = { ErrorOf( ES_SERVER, 450, E_FAILED, EV_USAGE, 0 ), "Usage: %'copy [ -c changelist# -f -F -m max -n -q -r -s from -v ] [ -b branch to... | [-As | -Af] -S stream [ -P parent ] [ file... ] | from to ]'%" } ;
...
ErrorId MsgServer::UseCopyS            = { ErrorOf( ES_SERVER, 508, E_FAILED, EV_USAGE, 0 ), "Usage: %'copy [ -c changelist# -f -F -m max -n -q -r -s from -v ] [-As | -Af]  -S stream [ -P parent ] [ file... ]'%" } ;
...
ErrorId MsgServer::UseInteg            = { ErrorOf( ES_SERVER, 246, E_FAILED, EV_USAGE, 0 ), "Usage: %'integrate [ -c changelist# -D<flags> -f -h -m max -n -Obr -q -r -s from -v ] [ -b branch to... | from to ] [ [-As | -Af] -S stream [ -P parent ] files... ]'%" } ;
...
ErrorId MsgServer::UseIntegS           = { ErrorOf( ES_SERVER, 507, E_FAILED, EV_USAGE, 0 ), "Usage: %'integrate [ -c changelist# -D<flags> -f -h -m max -n -Obr -q -r -s from -v ] [-As | -Af]  -S stream [ -P parent ] [ files... ]'%" } ;
...
ErrorId MsgServer::UseStorage          = { ErrorOf( ES_SERVER, 1009, E_FAILED, EV_USAGE, 0 ), "Usage: %'storage [ -w ] | [ -v [ -q ] | -U [ -q ] | -u | -d [ -q ] [ -y ] [ -D secs ] [ -t target ] ] [ -F filter -T fields -m max ] [ -c change ] archives... | -l start|pause|restart|wait|status|cancel //depotdirectory/...'%" } ;
...
ErrorId MsgServer::UseStreams          = { ErrorOf( ES_SERVER, 387, E_FAILED, EV_USAGE, 0 ), "Usage: %'streams [ -U -F filter -T fields -m max [ --viewmatch //depotPath1 [ [ --viewmatch //depotPathN ] ... ] ] ] [ streamPath... ]'%" } ;
