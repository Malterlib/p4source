...
ErrorId MsgServer2::UseDiags               = { ErrorOf( ES_SERVER2, 300, E_FAILED, EV_USAGE, 0 ), "Usage: %'diagnostics [ -L limit ] | [ [ -l ] [ -s [--strace-runtime secs] [-L limit]] [ [-a ] -L limit ] ]'%" } ;
...
ErrorId MsgServer2::DiagsDone              = { ErrorOf( ES_SERVER2, 313, E_INFO, EV_NONE, 1 ), "The diagnostics command has created the %dir% directory containing the files: %file%." } ;
...
ErrorId MsgServer2::StraceRuntime          = { ErrorOf( ES_SERVER2, 317, E_FAILED, EV_USAGE, 0 ), "Bad strace runtime parameter" } ;
ErrorId MsgServer2::StraceBusy             = { ErrorOf( ES_SERVER2, 318, E_FAILED, EV_USAGE, 0 ), "A strace request is currently active" } ;
