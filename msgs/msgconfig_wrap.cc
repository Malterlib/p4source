...
ErrorId MsgConfig::SysMemoryMiEagerregioncommit = { ErrorOf( ES_CONFIG, 293, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiEagerregioncommit placeholder." };
ErrorId MsgConfig::SysMemoryMiResetdecommits = { ErrorOf( ES_CONFIG, 294, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiResetdecommits placeholder." };
ErrorId MsgConfig::SysMemoryMiLargeospages = { ErrorOf( ES_CONFIG, 295, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiLargeospages placeholder." };
...
ErrorId MsgConfig::SysMemoryMiPagereset = { ErrorOf( ES_CONFIG, 300, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiPagereset placeholder." };
ErrorId MsgConfig::SysMemoryMiAbandonedpagereset = { ErrorOf( ES_CONFIG, 301, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiAbandonedpagereset placeholder." };
ErrorId MsgConfig::SysMemoryMiSegmentreset = { ErrorOf( ES_CONFIG, 302, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiSegmentreset placeholder." };
...
ErrorId MsgConfig::SysMemoryMiDecommitDelay = { ErrorOf( ES_CONFIG, 304, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiDecommitDelay placeholder." };
...
ErrorId MsgConfig::SysMemoryMiDecommitextenddelay = { ErrorOf( ES_CONFIG, 313, E_INFO, EV_NONE, 0), "MsgConfig::SysMemoryMiDecommitextenddelay placeholder." };
