...
const char P4Tag::l_client[] = "89"; // Also update knownReleases in dmtypes.cc
...
const char P4Tag::l_server2[] = "51"; // generic server level
...
const char P4Tag::l_proxy[] = "10"; // proxy level
